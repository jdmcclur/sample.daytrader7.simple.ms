...
public class TradeServletAction {
   ...
   *  results A short description of the results/success of this web request
   *                provided on the web page
   *  javax.servlet.ServletException If a servlet specific exception is
   *                                           encountered
   *  javax.io.IOException           If an exception occurs while
