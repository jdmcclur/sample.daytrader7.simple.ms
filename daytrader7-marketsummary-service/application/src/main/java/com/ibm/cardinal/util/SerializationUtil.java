...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeDbUtils", "USER_REMOTE_TYPE");
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.JsonDecoder", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.JsonEncoder", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.websocket.JsonMessage", "USER_LOCAL_TYPE");
