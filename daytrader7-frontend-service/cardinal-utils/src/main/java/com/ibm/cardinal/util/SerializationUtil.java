...
public class SerializationUtil {
    ...
    static {
        ...
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeDbUtils", "USER_LOCAL_TYPE");
        type_category_map.put("com.ibm.websphere.samples.daytrader.web.TradeScenarioServlet", "USER_LOCAL_TYPE");
