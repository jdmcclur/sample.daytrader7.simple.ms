...
public class TradeActionService {
    private static final Logger klu__logger = CardinalLogger.getLogger(TradeActionService.class);
    ...
    public String getHealth() { 
        klu__logger.info("[TradeAction] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[TradeActionService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[TradeAction] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response getMarketSummary(
        ...
        klu__logger.info("[TradeAction] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
