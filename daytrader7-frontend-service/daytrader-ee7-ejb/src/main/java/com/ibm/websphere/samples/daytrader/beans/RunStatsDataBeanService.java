...
public class RunStatsDataBeanService {
    private static final Logger klu__logger = CardinalLogger.getLogger(RunStatsDataBeanService.class);
    ...
    public String getHealth() { 
        klu__logger.info("[RunStatsDataBean] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[RunStatsDataBeanService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[RunStatsDataBean] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response toString(
        ...
        klu__logger.info("[RunStatsDataBean] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
