...
public class FinancialUtilsService {
    private static final Logger klu__logger = CardinalLogger.getLogger(FinancialUtilsService.class);
    ...
    public Response FinancialUtils_default_ctor() {
        ...
        JsonObject jsonobj = Json
            ...
            .build();
        klu__logger.info("[FinancialUtilsService] Returning JSON object: "+jsonobj.toString());
        return Response
    ...
    public String getHealth() { 
        klu__logger.info("[FinancialUtils] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[FinancialUtilsService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[FinancialUtils] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response computeGain(
        ...
        try {
            ...
            String msg = "Call to method computeGain() of FinancialUtils raised exception: "+t.getMessage();
        ...
        klu__logger.info("[FinancialUtils] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
    ...
    public Response computeGainPercent(
        ...
        try {
            ...
            String msg = "Call to method computeGainPercent() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
    ...
    public Response computeHoldingsTotal(
        ...
        try {
            ...
            String msg = "Call to method computeHoldingsTotal() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
    ...
    public Response printGainHTML(
        ...
        try {
            ...
            String msg = "Call to method printGainHTML() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
    ...
    public Response printChangeHTML(
        ...
        try {
            ...
            String msg = "Call to method printChangeHTML() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
    ...
    public Response printGainPercentHTML(
        ...
        try {
            ...
            String msg = "Call to method printGainPercentHTML() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
    ...
    public Response printQuoteLink(
        ...
        try {
            ...
            String msg = "Call to method printQuoteLink() of FinancialUtils raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        JsonObjectBuilder jsonresp = Json.createObjectBuilder();
