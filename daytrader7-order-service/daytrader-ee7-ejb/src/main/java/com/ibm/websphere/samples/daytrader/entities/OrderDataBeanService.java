...
public class OrderDataBeanService {
    private static final Logger klu__logger = CardinalLogger.getLogger(OrderDataBeanService.class);
    ...
    public String getHealth() { 
        klu__logger.info("[OrderDataBean] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[OrderDataBeanService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[OrderDataBean] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response getRandomInstance(
        ...
        try {
            ...
            String msg = "Call to method getRandomInstance() of OrderDataBean raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        ...
        klu__logger.info("[OrderDataBean] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
