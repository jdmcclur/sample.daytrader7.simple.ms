...
daytrader-ms.jmx is an Apache JMeter script that may be used for running the DayTraderMS benchmark.

Jmeter version 4.0 or later is highly recommended.
...
WS NOTE: To enable encrypted WebSocket, either open daytrader-ms.jmx using the GUI and enable WSS on the WS2 and WS1 calls, or edit the daytrader-ms.jmx file and change the TLS prop to true.

Example: ./jmeter -n -t daytrader-ms.jmx -JHOST=myserver -JPORT=9082 -JPROTOCOL=http -JMAXTHINKTIME=100 -JDURATION=300
