...
public class DBUtil {
  ...
  public void createDB() throws Exception {
    ...
    System.out.println("DBUtil: Building DayTrader Account Database... This operation will take several minutes. Please wait...");
    ...
    if (ddlFile != null) {
      ...
      System.out.println("DBUtil: **** Dropping and Recreating the Account tables... ****");
      try {
      ...
      if (!success) {
        System.out.println(
            "DBUtil: **** Unable to drop and recreate DayTrader Db Account Tables, please check for database "
                + "consistency before continuing ****");
        return;
      }
      System.out.println(
          "DBUtil: **** DayTrader account tables successfully created! ****< Please use the \"Repopulate Daytrader Database\" link to populate your database.");
      return;
