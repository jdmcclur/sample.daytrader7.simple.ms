...
public class AccountProfileDataBeanService {
    private static final Logger klu__logger = CardinalLogger.getLogger(AccountProfileDataBeanService.class);
    ...
    public String getHealth() { 
        klu__logger.info("[AccountProfileDataBean] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[AccountProfileDataBeanService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[AccountProfileDataBean] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response getRandomInstance(
        ...
        try {
            ...
            String msg = "Call to method getRandomInstance() of AccountProfileDataBean raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        ...
        klu__logger.info("[AccountProfileDataBean] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
