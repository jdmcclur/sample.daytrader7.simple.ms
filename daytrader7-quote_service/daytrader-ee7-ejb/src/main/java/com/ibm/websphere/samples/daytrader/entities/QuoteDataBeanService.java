...
public class QuoteDataBeanService {
    private static final Logger klu__logger = CardinalLogger.getLogger(QuoteDataBeanService.class);
    ...
    public String getHealth() { 
        klu__logger.info("[QuoteDataBean] getHealth() called");
    ...
    public void incObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[QuoteDataBeanService] incObjectCount() called with ref: "+klu__referenceID);
    ...
    public void decObjectCount(@FormParam("klu__referenceID") String klu__referenceID) {
        klu__logger.info("[QuoteDataBean] decObjectCount() called with ref: "+klu__referenceID);
    ...
    public Response getRandomInstance(
        ...
        try {
            ...
            String msg = "Call to method getRandomInstance() of QuoteDataBean raised exception: "+t.getMessage();
            klu__logger.warning(msg);
            throw new WebApplicationException(msg, t, CardinalException.APPLICATION_EXCEPTION);
        }
        ...
        klu__logger.info("[QuoteDataBean] Returning JSON object: "+jsonobj.toString());
        return Response
            .status(Response.Status.OK)
            .entity(jsonobj)
            .build();
