...
public class TradeAction implements KluInterface, TradeServices {
    ...
    private static final Logger klu__logger = CardinalLogger.getLogger(TradeAction.class);

    static {
        klu__client = ClientBuilder.newClient();

        klu__logger.info("Static initializer of TradeAction of cluster frontend_service");
        ...
        klu__serviceURI += "TradeActionService";
        ...
        try {
            ...
            throw new java.lang.RuntimeException("Invalid URI for partition frontend_service, "+
                "service TradeActionService: "+klu__serviceURI, e);
        }

        klu__logger.info("frontend_service TradeActionService URI = " + klu__serviceURI);
    }
  ...
  public TradeAction() {
        ...
        Form form = new Form();
        klu__logger.info("[TradeAction] Calling service "+klu__serviceURI+
        ...
        try {
            ...
            klu__logger.warning("[TradeAction] Exception thrown in service call: "+wae.getMessage());
            throw (java.lang.RuntimeException)cause;
        }
        String response_json_str = svc_response.readEntity(String.class);
        klu__logger.info("[TradeAction] Response JSON string: "+response_json_str);
  ...
  public MarketSummaryDataBean getMarketSummary() throws Exception {
        ...
        try {
            ...
            if (wae.getResponse().getStatus() == CardinalException.APPLICATION_EXCEPTION) {
                klu__logger.warning("[TradeAction] Re-throwing wrapped application exception: ");
