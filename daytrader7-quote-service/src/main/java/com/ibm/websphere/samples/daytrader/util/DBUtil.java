...
public class DBUtil {
  ...
  public void createDB() throws Exception {
    ...
    System.out.println("DBUtil: Building DayTrader Quote Database... This operation will take several minutes. Please wait...");
    ...
    if (ddlFile != null) {
      ...
      System.out.println("DBUtil: **** Dropping and Recreating the Quote tables... ****");
      try {
      ...
      if (!success) {
        System.out.println(
            "DBUtil: **** Unable to drop and recreate DayTrader Db Quote Tables, please check for database "
                + "consistency before continuing ****");
        return;
      }
      System.out.println(
          "DBUtil: **** DayTrader quote table successfully created! ****< Please use the \"Repopulate Daytrader Database\" link to populate your database.");
      return;
  ...
  public void resetTrade(boolean deleteAll) throws Exception {
    ...
    try {
      ...
      System.out.println("quotes reset\n\n");
    } catch (Exception e) {
