...
<BODY bgcolor="#ffffff" link="#000099" vlink="#000099">
  <%@ page
    import="java.util.Collection, java.math.BigDecimal,com.ibm.websphere.samples.daytrader.entities.QuoteDataBean,
    ...
    <TABLE height="54">
      <TBODY>
        <TR>
          <TD bgcolor="#c93333" align="left" width="640" height="10" colspan=6><B>
              <FONT color="#ffffff">DayTrader Quotes</FONT>
            </B></TD>
        ...
        <% Collection<?> closedOrders = (Collection
          ...
          <TR align="center">
            ...
            <TD>
              <%=FinancialUtils.printQuoteLink(closedOrderData.getQuoteSymbol())%>
            </TD>
            <TD>
    ...
    <% } %>
                      ...
                      <TABLE border="1" style="font-size: smaller">
                        <TBODY>
                          <TR align="center">
                            ...
                            <TD><A href="docs/glossary.html">price
                                range</A></TD>
                            <TD><A href="docs/glossary.html">open
                                price</A></TD>
                            <TD><A href="docs/glossary.html">current
                                price</A></TD>
                          ...
                          <% // Create Hashmap for quick lookup of quote values 
                            ...
                            <TR align="center" bgcolor="#fafcb6">
                              ...
                              <TD>
                                <%=quoteData.getLow() + " - " + quoteData.getHigh()%>
                              </TD>
                              <TD nowrap>
                                <%=quoteData.getOpen()%>
                              </TD>
                              <TD>$ <%=quoteData.getPrice()%>
                              </TD>
                              <TD>
                                <%=FinancialUtils.printGainHTML(new BigDecimal(quoteData.getChange()))%>
                                  <%=FinancialUtils.printGainPercentHTML(FinancialUtils.computeGainPercent(quoteData.getPrice(),
                                    quoteData.getOpen()))%>
                              </TD>
                              <TD>
                                <FORM action="">
                            ...
                            <% } catch (Exception e) { System.out.println("displayQuote.jsp exception. Check that symbol: exists in the database."); 
                              } 
                            } %>
      ...
      <TABLE height="54" style="font-size: smaller">
        <TBODY>
          ...
          <TR>
            <TD bgcolor="#c93333" align="left" width="640" height="10"><B>
