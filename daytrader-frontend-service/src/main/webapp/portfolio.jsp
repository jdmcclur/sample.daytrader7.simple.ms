...
<BODY bgcolor="#ffffff" link="#000099" vlink="#000099">
    <%@ page
        import="java.util.Collection, 
                java.util.Iterator, 
                java.util.HashMap, 
                java.math.BigDecimal,com.ibm.websphere.samples.daytrader.entities.HoldingDataBean,com.ibm.websphere.samples.daytrader.entities.OrderDataBean,com.ibm.websphere.samples.daytrader.entities.QuoteDataBean,com.ibm.websphere.samples.daytrader.util.FinancialUtils"
                    ...
                    <TABLE border="1" style="font-size: smaller">
                        <TBODY>
                            ...
                            <TR align="center">
                                ...
                                <TD><%=FinancialUtils.printQuoteLink(closedOrderData.getQuoteSymbol())%></TD>
                                    ...
                                    <TABLE border="1"
                                        ...
                                        <TBODY>
                                            ...
                                            <%
                                                ...
                                                try {
                                                    while (it.hasNext()) {
                                                        ...
                                                        QuoteDataBean quoteData = (QuoteDataBean) quoteMap.get(holdingData.getQuoteSymbol());
                                                        ...
                                                        if (basis.doubleValue() == 0.0) {
                                                            ...
                                                            {log.error("portfolio.jsp: Holding with zero basis. holdingID=" + holdingData.getHoldingID() + " symbol=" + holdingData.getQuoteSymbol()
                                            ...
                                            <TR bgcolor="#fafcb6"
                                                ...
                                                <TD><%=FinancialUtils.printQuoteLink(holdingData.getQuoteSymbol())%></TD>
